      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/login">
              <Button variant="ghost" className="hover:scale-105 transition-transform cursor-pointer">
                로그인
              </Button>
            </Link>
            <Link href="/signup">
              <Button className="hover:scale-105 transition-transform cursor-pointer">회원가입</Button>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <div className="flex-1">
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link href="/signup">
              <Button size="lg" className="gap-2 hover:scale-105 transition-transform cursor-pointer">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-2 hover:border-primary transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">자원봉사자</h3>
                <p className="text-muted-foreground mb-4">기부와 수혜를 연결하는 다리가 되어주세요</p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• 배달 봉사 참여</li>
                  <li>• 이웃 사랑 실천</li>
                  <li>• 봉사 활동 내역 관리</li>
